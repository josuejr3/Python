...
#### <span style="color:rgb(4, 255, 0)">Propriedades de arquivos e pastas</span>

Em resumo a função os.getsize nos retorna o tamanho do arquivo, enquanto que a os.stat vai retornar as estatísiticas do arquivo em si, como por exemplo, permissões data e hora de criação, espaço e entre outros detalhes. 

```Python
# os.path.getsize e os.stat para dados dos arquivos (tamanho em bytes)Add commentMore actions
import math
import os
